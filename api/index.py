...
text_model_path = os.path.join(dirname,
                               "../huggingface/hub/models--microsoft--speecht5_tts/snapshots/30fcde30f19b87502b8435427b5f5068e401d5f6")
vocoder_model_path = os.path.join(dirname,
                                  "../huggingface/hub/models--microsoft--speecht5_hifigan/snapshots/bb6f429406e86a9992357a972c0698b22043307d")
datasets_path = os.path.join(dirname,
                             "../huggingface/hub/datasets--Matthijs--cmu-arctic-xvectors/snapshots/36e87b347a6a70f0420445b02ec40c55556f9ed7/default")
